...
این سرویس آنلاین ، تولید و مدیریت کانفیگ‌های پروکسی (VLESS/V2Ray و ClashMeta و SingBox) را به صورت خودکار انجام می‌دهد. کاربران از طریق پنل وب ، می‌توانند تنظیمات اتصال ، امنیت و شبکه را سفارشی کرده و لینک اشتراک دریافت کنند.
