...
<br>
<p align="center">
  <img src="docs/assets/images/panel-overview1.5.4.jpg">
</p>
<br>
...
این سرویس آنلاین ، تولید و مدیریت کانفیگ‌های پروکسی ( Shadowsocks , VLESS/V2Ray و ClashMeta و SingBox) را به صورت خودکار انجام می‌دهد. کاربران از طریق پنل وب ، می‌توانند تنظیمات اتصال ، امنیت و شبکه را سفارشی کرده و لینک اشتراک دریافت کنند.
...
- امکان فیلتر بر اساس :
   • نوع شبکه (TCP, WebSocket, gRPC, HTTP, HTTPS)
   • نوع امنیت (TLS, Reality, بدون امنیت)
✅ پشتیبانی کامل از Custom Subscribes
✅ پشتیبانی از کانفیگ‌های اختصاصی کاربر
✅ ترکیب هوشمند کانفیگ‌های پیشفرض و اختصاصی

✅ سیستم فیکس آی‌پی هوشمند

· تعویض خودکار IP با حفظ SNI
· پشتیبانی از چندین IP به صورت همز!
